...
function ApplyJobModal({
    ...
    const handleOnFinish = (data: SubmitApplicationData) => {
        ...
        for(const key in data.files){
            if(data.files[key]){
                formData.append(key, data.files[key][0].originFileObj!)
            }
        }
    ...
    return(
        <Modal
            title={
                <div className="pt-4 px-2 sticky top-0">
                    <div className="mb-6">
            ...
            centered
        >
            <div className="max-h-[60vh] sm:max-h-[70vh] overflow-y-auto overflow-x-hidden px-1 py-4">
                <Form 
                    form={form}
                    layout="vertical"
